...
<Tabs --right=0 --left=none bind:activeTabValue={currentTab} items={tabItems} />
{#if 1 === currentTab}
	<Stats {op} bind:selectedPhase bind:currentLevel {attributes} {maxLevel}/>
{/if}
